#include "WireCellSpng/TorchTensorFileSource.h"
...
WIRECELL_FACTORY(SPNGTorchTensorFileSource, WireCell::SPNG::TorchTensorFileSource,
                 WireCell::INamed,
...
WireCell::Configuration TorchTensorFileSource::default_configuration() const
{
    Configuration cfg;
    cfg["inname"] = m_inname;
    cfg["prefix"] = m_prefix;
...
void TorchTensorFileSource::configure(const WireCell::Configuration& cfg)
{
...
void TorchTensorFileSource::clear()
{
    m_cur = header_t();
}
