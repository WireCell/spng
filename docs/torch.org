...
- [ ] Function to convert ~Response::Schema::FieldResponse~ into tensors

- [ ] Function to sample / convert ER, RC to tensor.

- [ ] Function to convert per-chan-response to tensor.

- [ ] Function to convert ~IFrame~ into tensors.

- [ ] New ~IData~ to hold a torch tensor. (NOT an ~ITensor~)

- [ ] New ~INode~'s pass this new ~IData~.

- [ ] Functions to produce above type tensors direct from data for test/dev purposes.
