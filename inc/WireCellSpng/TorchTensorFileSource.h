#ifndef WIRECELL_SPNG_TORCHTENSORFILESOURCE
#define WIRECELL_SPNG_TORCHTENSORFILESOURCE
...
namespace WireCell::SPNG {
    ...
    class TorchTensorFileSource : public Aux::Logger, public ITorchTensorSetSource,
                             public WireCell::IConfigurable, public WireCell::ITerminal

    {
      public:
        TorchTensorFileSource();
        virtual ~TorchTensorFileSource();
